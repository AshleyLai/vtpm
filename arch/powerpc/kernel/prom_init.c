...
#ifdef CONFIG_PPC64
/*
 * Get the Stored Measurement Log (SML)
 */
static void __init prom_get_of_event_log(void)
{
	...
	prom_debug("prom_get_of_event_log: start...\n");
	...
	prom_debug("prom_get_of_event_log: end...\n");
}
#endif /* CONFIG_PPC64 */
